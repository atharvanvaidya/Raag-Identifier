...
for i1 in range(1, LIMIT):
    ...
    matrixB = probability(inputMatrix(matrixB, baseSetB, 10))
...
resultarray.sort()
for x in range(0, 9):
    print (str(resultarray[x]) + "\t\tSong No.:" + str(ragas[toparray.index(resultarray[x])]))

print ("First Best Match Raga:" + str(ragas[toparray.index(resultarray[0])]))
